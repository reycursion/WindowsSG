...
>Note: It is easy to get many layers deep if you continue to do this. To go back a layer to your previous shell, type the word "exit". If you type exit from your original shell you will close out your CLI. So be careful not to type exit too many times. Certain variables, functions, etc. that you create may only exist in that session. If you close they will delete from memory unless saved in your profile file, which will be covered in your PowerShell module.
